...
<ui:composition xmlns="http://www.w3.org/1999/xhtml"
    ...
    <f:metadata>
        ...
        <ui:param name="filterUi" value="/WEB-INF/resources/${MODULE_NAME}/filter/${ROLE_FILE_BASE}-filterui.xhtml" />
        <ui:include src="/WEB-INF/resources/${MODULE_NAME}/filter/meta/${ROLE_FILE_BASE}-filterui.xhtml" />
